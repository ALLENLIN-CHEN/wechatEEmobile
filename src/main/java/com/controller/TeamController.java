...
//            Integer teamId = Integer.parseInt(json.get("teamId").toString());
            ...
            List<TeamUser> teamUsers = teamUserService.findTeamUsersByOpenIdAndTeamId(openId, teamId);
            TeamUser teamUserForOpen = null;
            if (teamUsers != null && !teamUsers.isEmpty())
                teamUserForOpen = teamUsers.get(0);
...
//            TeamUser teamUserForOpen=teamUserService.findTeamUsersByOpenIdAndTeamId(openId, teamId).get(0);
            ...
            if (projectMember != null && projectMember.getRoleType() != 'd') {
                canModify = 1;
            }
